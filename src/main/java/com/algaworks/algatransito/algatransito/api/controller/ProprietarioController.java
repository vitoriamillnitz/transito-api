...
import com.algaworks.algatransito.algatransito.domain.service.RegistroProprietarioService;
...
public class ProprietarioController {
    ...
    public List<Proprietario> listar() {
        return proprietarioRepository.findAll(); // vamos listar todos os funcionarios
    }
